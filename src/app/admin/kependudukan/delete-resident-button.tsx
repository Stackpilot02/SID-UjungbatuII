...
export default function DeleteResidentButton({ id, name }: { id: string; name: string }) {
  ...
  return (
    <button onClick={() => setConfirming(true)} className="text-[var(--color-danger)] hover:underline text-xs" title={`Hapus ${name}`}>
      Hapus
    </button>
  );
}